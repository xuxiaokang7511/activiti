		  ...
		  <tr>
		  	<td>
			  		<div align="left" class="STYLE21">
				 		请假天数:<s:textfield name="days" cssStyle="width: 200px;" disabled="true" ></s:textfield><br/>
				 		请假原因:<s:textfield name="content" cssStyle="width: 800px;"  disabled="true"></s:textfield><br/>
				 		请假备注:<s:textarea name="remark" cols="30" rows="2" disabled="true"></s:textarea><br/>
